...
static WebDriver driver;
	 ...
	 */
	public  void takeSnapShot(WebDriver webdriver,String filename1,String filename2) throws Exception{
        ...
        //Call getScreenshotAs method to create image file
            ...
            //Move image file to new destination
              ...
              //  File DestFile=new File(fileWithPath+"opty"+".jpg");

                //Copy file at destination
String filename=filename1.concat(filename2);
              //  FileUtils.copyFile(SrcFile, new File(System.getProperty("user.dir")+"/Screenshot/"+"opty"+".jpg"));
                FileUtils.copyFile(SrcFile, new File(System.getProperty("user.dir")+"/Extenteport&Screenshot/"+filename+".jpg"));
             //   FileUtils.copyFile(SrcFile, new File("\\\\houfip01\\BusinessDir\\Information Systems\\DSP"+"/Screenshot/"+filename+".jpg"));
    }
	 ...
	 */
	public void contactgenrationbtn(WebDriver driver, WebElement element) {
		try {
			(new WebDriverWait(driver, ConstantVariables.explicitWait))
					.until(ExpectedConditions.elementToBeClickable(element));
			element.click();
	...
	public void vshortWait() throws InterruptedException {
		Thread.sleep(2000);
	}
	...
	public void mintermediatewait() throws InterruptedException {
		Thread.sleep(7000);
	}
	
	public void midintermediatewait() throws InterruptedException {
		Thread.sleep(17000);
	}
	
	public void Renewalprogresstracker() throws InterruptedException {
		Thread.sleep(220000);
	}
	...
	public void AggregateSitesProgress() throws InterruptedException {
		Thread.sleep(120000);
	}
	
	public void AggregateSitesProgressTracker() throws InterruptedException {
		Thread.sleep(140000);
	}
	
	public void AddsitesProgressTracker() throws InterruptedException {
		Thread.sleep(190000);
	}
	
	public void AddsiteProgressTracker() throws InterruptedException {
		Thread.sleep(160000);
	}
	
	public void dealconversion1() throws InterruptedException {
		Thread.sleep(220000);
	}
	
	public void dealconversion2() throws InterruptedException {
		Thread.sleep(360000);
	}
	
	public void dealconversion3() throws InterruptedException {
		Thread.sleep(240000);
	}
	
	public void cloudlogin() throws InterruptedException {
		Thread.sleep(10000);
	}
	
	public void cloudlogin1() throws InterruptedException {
		Thread.sleep(30000);
	}
	public void waituntilcontactgenerationisvisible() throws InterruptedException {
		Thread.sleep(220000);
	}
	...
	public void waituntilAggregatecontract() throws InterruptedException {
		Thread.sleep(550000);
	}
	public void waituntilRenewalAggregatecontract() throws InterruptedException {
		Thread.sleep(450000);
	}
	
	public void waituntilcontactgeneration() throws InterruptedException {
		Thread.sleep(50000);
	}
	
	public void waitforcontractstatus() throws InterruptedException {
		Thread.sleep(300000);
	}
	...
	public boolean waitFor(WebDriver driver,WebElement element,int seconds) {
		 ...
		 */
		 ...
		 /**
			 * @param //driver
			 *          This Method is for identifying Shadow root element
			 */
		...
		public void waitForLoad(WebDriver driver) {
			    new WebDriverWait(driver, 75).until((ExpectedCondition<Boolean>) wd ->
			            ((JavascriptExecutor) wd).executeScript("return document.readyState").equals("complete"));
			}
		 public String DspEncryption() throws IOException {
		        ConfigReader config = new ConfigReader();
		        Properties prop = config.init_properties();
		        String encPass = prop.getProperty("DspPassword");
		        System.out.println(encPass);
		 ...
		 public String AccessKeyEncryption() throws IOException {
		        ConfigReader config = new ConfigReader();
		        Properties prop = config.init_properties();
		        String encPass = prop.getProperty("AccessKey");
		        System.out.println(encPass);
