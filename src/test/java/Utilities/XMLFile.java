...
public class XMLFile {
	...
	public void OptyXMLReliant() throws Throwable {
		ReadXMLFile xml=new ReadXMLFile();
		HashMap<String, String > OptyHeader = xml.getSubmittedOptyFromXML();
		opportunity.CreateNewOpportunityReliant(OptyHeader);

	}
	public String OptyXMLAnalyst() throws Throwable {
		ReadXMLFile xml=new ReadXMLFile();
		HashMap<String, String > OptyHeader = xml.getSubmittedOptyFromXML();
		return opportunity.CreateAnalyst(OptyHeader);
	...
	public String OptyXMLMatrixless() throws Throwable {
		ReadXMLFile xml=new ReadXMLFile();
		HashMap<String, String > OptyHeader = xml.getSubmittedOptyFromXML();
		return opportunity.CreateMatrixlessthan50Opportunity(OptyHeader);
	}
}