...
public class AggregateRenewalEnrollment {
	...
	public void dsp_select_renew_option_for_the_active_contract_found() throws Throwable {
		testContext.scenarioContext.setContext(Context.OPTY_ID,customer.SelectRenewButtonforAggregate(prop.getProperty("Renewcustname"),prop.getProperty("RenewAggcustname")));
	}

	
	@Then("DSP:Generate Contract for Renewal Aggregate Customer in DSP")
	public void Generating_Contract_RenewalAggregate_in_DSP() throws Throwable {
	...
	public void View_Contracts_RenewalAggregate() throws Throwable {
