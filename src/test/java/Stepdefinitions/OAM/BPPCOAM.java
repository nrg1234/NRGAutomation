...
String Scenario="Validate Aggregate Customer addition is not allowed Broker Enrollment < 50Kwh from OAM";
    ...
    public void dsp_navigate_to_contract_and_billing_oam() throws Throwable {
    	testContext.scenarioContext.setContext(Context.OPTY_ID,oam.ContractandBilling());
    	
}
    @Then("VHOS:Validate MVP oam")
    public void vhos_validate_mvp_oam() throws Throwable {
        vhosPage.ValidateMVPVHOS((String) testContext.scenarioContext.getContext(Context.OPTY_ID));
    }
}
