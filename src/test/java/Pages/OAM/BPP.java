...
//	WebElement termbtn = shadowDom7.findElement(By.cssSelector("#matrix-term"));
    ...
    public String ContractandBilling() throws Throwable{
        JavascriptExecutor js = (JavascriptExecutor) driver;
        ...
        String roo10 = "return document.querySelector(\"body > modal-container > div > div > app-address-validation-modal > app-modal\").shadowRoot.querySelector(\"div > div.modal-body > div > div.row.button-row.ng-star-inserted > div:nth-child(2) > div > button\")";
