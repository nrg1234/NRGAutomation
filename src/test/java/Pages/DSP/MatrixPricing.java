...
public class MatrixPricing {
    ...
    public void Addcustomer() throws Throwable {
        ...
        functions.shortWait();
     //   document.querySelector("body > modal-container > div > div > app-add-customer-modal > app-modal").shadowRoot.querySelector("div > div.modal-body > div > div.row.mt-2.text-center > div.col-12.p-0.mb-4 > div > input")
      ...
      functions.shortWait();
     functions.click(driver, dropdowncustomer);
...
//
	...
	//	document.querySelector("#embedded-app-container > app-broker-pricing").shadowRoot.querySelector("div > app-quote > fieldset > div.content > app-sites > div.row.mt-4.justify-content-between.ng-star-inserted > div.col-auto > div > div.d-inline-block.align-top.pt-2 > button:nth-child(3) > span")
...
functions.longWait();
        ...
        functions.setText(driver, entersite, "10443720006663153");
        //  functions.setText(driver, entersite, "10443720002827434");
        functions.shortWait();
        // enter srt date
        ...
        functions.setText(driver, srtdate, "07/01/2022");
...
//        functions.intermediatewait();
        ...
        String roo18 = "return  document.querySelector(\"body > modal-container > div > div > app-add-sites-modal > app-modal\").shadowRoot.querySelector(\"div > div.modal-body > div > div:nth-child(3) > div > app-bill-copy > form > div:nth-child(3) > div:nth-child(2) > mat-datepicker-toggle > button > span > mat-icon > span\")";
        WebElement calender = (WebElement) js.executeScript(roo18);
        functions.click(driver, calender);
        //	functions.setText(driver, enddate, "11/30/2021");
        String roo19 = "return  document.querySelector(\"#mat-datepicker-2 > mat-calendar-header > div > div > button.mat-focus-indicator.mat-calendar-previous-button.mat-icon-button.mat-button-base\")";
        WebElement calenderback = (WebElement) js.executeScript(roo19);
        functions.click(driver, calenderback);
        String roo20 = "return   document.querySelector(\"#mat-datepicker-2 > div > mat-month-view > table > tbody > tr:nth-child(6) > td > div\")";
        WebElement calenderlastdate = (WebElement) js.executeScript(roo20);
        functions.click(driver, calenderlastdate);
...
//				.findElement(By.cssSelector("#matrix-product-name > div > div.row > div.col-9.pr-0 > input"));
        ...
        functions.minwait();
        functions.setText(driver, productdropdownbtn, "FIXED PRODUCT BUNDLED GREEN");
        functions.minwait();
...
//		WebElement termbtn = shadowDom7.findElement(By.cssSelector("#matrix-term"));
        ...
        functions.setText(driver, termbtn, "6");
        functions.shortWait();
        ...
        functions.setText(driver, brokerfeebtn, "1");
        functions.shortWait();
        ...
        functions.setText(driver, Contractpricebtn, "160");
        functions.intermediatewait();
...
//        functions.intermediatewait();
    ...
    public void SelectSmallFixedProduct() throws Throwable {
        // filling details in quote summary page
        JavascriptExecutor js = (JavascriptExecutor) driver;
//		WebElement root7 = driver.findElement(By.tagName("app-broker-pricing"));
//		WebElement shadowDom7 = (WebElement) js.executeScript("return arguments[0].shadowRoot", root7);
...
//				.findElement(By.cssSelector("#matrix-product-name > div > div.row > div.col-9.pr-0 > input"));
        ...
        functions.click(driver, productdropdownbtn);
        functions.minwait();
        functions.setText(driver, productdropdownbtn, " SMALL FIXED PRICE ");
        productdropdownbtn.sendKeys(Keys.ENTER);
        functions.shortWait();
    }
    public void SelectSmallFixedGreenProduct() throws Throwable {
        // filling details in quote summary page
        JavascriptExecutor js = (JavascriptExecutor) driver;
//		WebElement root7 = driver.findElement(By.tagName("app-broker-pricing"));
//		WebElement shadowDom7 = (WebElement) js.executeScript("return arguments[0].shadowRoot", root7);
...
//				.findElement(By.cssSelector("#matrix-product-name > div > div.row > div.col-9.pr-0 > input"));
      ...
      //  functions.click(driver, productdropdownbtn);
        ...
        functions.setText(driver, productdropdownbtn, " SMALL FIXED PRICE GREEN ");
        functions.minwait();
        Robot robot =new Robot();
        robot.keyPress(KeyEvent.VK_ENTER);
    //    productdropdownbtn.sendKeys(Keys.TAB);
        functions.shortWait();
    }
    public void ContinuetoQuotesummary() throws Throwable {
        // filling details in quote summary page
        JavascriptExecutor js = (JavascriptExecutor) driver;
//		WebElement root7 = driver.findElement(By.tagName("app-broker-pricing"));
//		WebElement shadowDom7 = (WebElement) js.executeScript("return arguments[0].shadowRoot", root7);
...
//        functions.intermediatewait();
    ...
    public void NegativeBrokerfee() throws Throwable {
        // filling details in quote summary page
        JavascriptExecutor js = (JavascriptExecutor) driver;
//		WebElement root7 = driver.findElement(By.tagName("app-broker-pricing"));
//		WebElement shadowDom7 = (WebElement) js.executeScript("return arguments[0].shadowRoot", root7);
...
//				.findElement(By.cssSelector("#matrix-product-name > div > div.row > div.col-9.pr-0 > input"));
    ...
    public void ContinuetoQuotesummaryNegativescenario() throws Throwable {
        // filling details in quote summary page
        JavascriptExecutor js = (JavascriptExecutor) driver;
//		WebElement root7 = driver.findElement(By.tagName("app-broker-pricing"));
//		WebElement shadowDom7 = (WebElement) js.executeScript("return arguments[0].shadowRoot", root7);
...
functions.mediumWait();
        ...
        functions.setText(driver, entersite, "10443720003535645");
   //   functions.setText(driver, entersite, "10443720002500634");
     //   functions.setText(driver, entersite, "10443720008694143");
        functions.shortWait();
        // enter srt date
        String roo7 = "return document.querySelector(\"body > modal-container > div > div > app-add-sites-modal > app-modal\").shadowRoot.querySelector(\"#contract-start-date\")";
        WebElement srtdate = (WebElement) js.executeScript(roo7);
...
//		WebElement browsebtn = shadowDom5.findElement(By.cssSelector("#browse-file"));
    ...
    public String lessthan50Quotesummary(String opportunityname) throws Throwable {
        // filling details in quote summary page
        JavascriptExecutor js = (JavascriptExecutor) driver;
