...
public class BrokerPricingNeg02 {
	...
	public String CreateNewOpportunity() throws Throwable {
	  ...
	  public String Addgreaterthan50sitesBillcopy() throws Throwable {
	        ...
	        functions.setText(driver, entersite, "10443720006060053");
	        functions.shortWait();
	        // enter srt date
...
//		functions.setText(driver, customerEmail2, "sridhar.dhusa@nrg.com");
	 ...
	 public void PricingsectionOAM() throws Throwable {
	        ...
	        WebElement selectbtn = (WebElement) js.executeScript(roo15);
	        functions.click(driver, selectbtn);
	       
	        String roo16 = " return document.querySelector(\"#embedded-app-container > app-broker-pricing\").shadowRoot.querySelector(\"div > app-quote > fieldset > div.content > app-pricing > form > div.row.justify-content-end.calc-and-proceed-row > button.btn.btn-primary.proceed-button.mx-3\")";
	        WebElement contractbillingbtn = (WebElement) js.executeScript(roo16);
