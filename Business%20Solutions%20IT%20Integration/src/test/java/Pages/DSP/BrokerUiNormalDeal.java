...
//click add contact to customer btn
		...
		functions.intermediatewait();
		//selectedaddress
		String roo10 = "return document.querySelector(\"body > modal-container > div > div > app-address-validation-modal > app-modal\").shadowRoot.querySelector(\"div > div.modal-body > div > div.row.button-row > div:nth-child(2) > div > button\")";
