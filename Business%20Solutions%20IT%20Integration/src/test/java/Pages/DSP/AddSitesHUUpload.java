...
public class AddSitesHUUpload {
	...
	public String AddSitestotheOptyHUUpload() throws InterruptedException {
		...
		StringSelection ss = new StringSelection(pdffile + "\\src\\test\\resources\\DataReader\\BGE+Scalar.xlsx");
