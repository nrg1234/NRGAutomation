...
public class MatrixPricing {
    ...
    public void Addcustomer() throws Throwable {
        ...
        functions.shortWait();
//        document.querySelector("body > modal-container > div > div > app-add-customer-modal > app-modal").shadowRoot.querySelector("#ngb-typeahead-1-1 > div > div")
//       // document.querySelector("body > modal-container > div > div > app-add-customer-modal > app-modal").shadowRoot.querySelector("#ngb-typeahead-1-1 > div > div")
//       // document.querySelector("body > modal-container > div > div > app-add-customer-modal > app-modal").shadowRoot.querySelector("#ngb-typeahead-1-1 > div > div > p.dropdown-select.name-styling")
//       String shadowDom9 = "return  document.querySelector(\"body > modal-container > div > div > app-add-customer-modal > app-modal\").shadowRoot.querySelector(\"#ngb-typeahead-1-1 > div > div\")";
