...
//}
	...
	public void dsp_navigate_to_pricing_section() throws Throwable {
		String Status=	matrix.Quotesummary();
	...
	public void dsp_select_small_fixed_product() throws Throwable {
	   matrix.SelectSmallFixedProduct();
	}
	@Then("DSP: Navigate to Quotes")
	public void dsp_navigate_to_quotes() throws Throwable {
	   matrix.ContinuetoQuotesummary();
	}
	@Then("DSP: Select Small Fixed Green Product")
	public void dsp_select_small_fixed_green_product() throws Throwable {
	  matrix.SelectSmallFixedGreenProduct();
	}
	@Then("DSP: Enter negative broker fee")
	public void dsp_enter_negative_broker_fee() throws Throwable {
	   matrix.NegativeBrokerfee();
	}
	@Then("DSP: Navigate to Quotes Negative")
	public void dsp_navigate_to_quotes_negative() throws Throwable {
	    matrix.ContinuetoQuotesummaryNegativescenario();
	}
