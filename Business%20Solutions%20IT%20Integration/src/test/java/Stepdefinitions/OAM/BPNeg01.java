...
public class BPNeg01  {
	...
	BrokerPricingNeg02 Neg2 = new BrokerPricingNeg02(base);
	...
	public void dsp_add_greater_than_fifty_sites_to_customers_in_new_opty_oam() throws Throwable {
		testContext.scenarioContext.setContext(Context.OPTY_ID,Neg2.Addgreaterthan50sitesBillcopy());
	}
	@Then("DSP:Pricing section oam")
	public void dsp_pricing_section_oam() throws Throwable {
	   Neg2.PricingsectionOAM();
	}
